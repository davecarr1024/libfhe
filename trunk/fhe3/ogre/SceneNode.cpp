...
namespace fhe
{
    ...
    Ogre::SceneManager* SceneNode::getSceneManager()
    {
        ...
        {
            if ( entity->hasFunc<Ogre::SceneManager*,void>("getSceneManager") )
            {
                return entity->call<Ogre::SceneManager*>("getSceneManager");
            }
        }
        return 0;
    }
    ...
    Ogre::SceneNode* SceneNode::getParentSceneNode()
    {
        for ( EntityPtr entity = getParentEntity(); entity; entity = entity->getParent() )
        {
            if ( entity->hasFunc<Ogre::SceneNode*,void>("getSceneNode") )
            {
                return entity->call<Ogre::SceneNode*>("getSceneNode");
            }
        }
        return 0;
    }
