...
(cl:defmethod cl:initialize-instance :after ((m <JointState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name re2robotModel-msg:<JointState> is deprecated: use re2robotModel-msg:JointState instead.")))
